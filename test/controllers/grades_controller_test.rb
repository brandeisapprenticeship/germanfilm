...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { comment: @grade.comment, grade: @grade.grade, submission_id: @grade.submission_id, user_id: @grade.user_id }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { comment: @grade.comment, grade: @grade.grade, submission_id: @grade.submission_id, user_id: @grade.user_id }
    assert_redirected_to grade_path(assigns(:grade))
  end
